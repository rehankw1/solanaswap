...
export const initSdk = async (walletPrivKey: any) => {

  owner = Keypair.fromSecretKey(bs58.decode(walletPrivKey))
  connection = new Connection('https://api.mainnet-beta.solana.com') //<YOUR_RPC_URL>
